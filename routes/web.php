...
Auth::routes();
Route::get('/dashboard', 'App\Http\Controllers\DashboardController@welcome')->name('welcome');
Route::get('/all-users', 'App\Http\Controllers\DashboardController@index')->name('index');
...
Route::get('/red', [App\Http\Controllers\FrontendController::class, 'radio_scrape'])->name('home');
